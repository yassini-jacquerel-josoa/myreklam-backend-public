...
function getCommentairesByAnnonceId($conn)
{
    ...
    $query = "SELECT commentaires.*, ui.pseudo, ui.nomsociete, ui.profiletype, ui.photoprofilurl FROM \"commentaires\" JOIN \"userInfo\" ui ON \"commentaires\".\"userid\" = ui.\"userid\" WHERE \"annonceid\" = :annonceid";
    $statement = $conn->prepare($query);
