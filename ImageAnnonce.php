...
// Fonction pour créer des images d'annonces
...
//         $fields = ['id' => $id, 'annonceid' => $annonceId, 'urlimg' => $urlImg, 'isdeleted' => $isDeleted];
//         $columns = ['id', 'annonceid', 'urlimg', 'isdeleted'];
//         $placeholders = [':id', ':annonceid', ':urlimg', ':isdeleted'];

//         // Construire la requête d'insertion
//         $query = 'INSERT INTO "imageAnnonce" (' . implode(', ', $columns) . ') VALUES (' . implode(', ', $placeholders) . ')';
//         $statement = $conn->prepare($query);
...
//             // echo json_encode([
//             //     "status" => "success",
//             //     "message" => "Image ajoutée avec succès dans l'annonce.",
//             //     // "id" => $id
//             // ]);
//         } else {
//             // echo json_encode([
//             //     "status" => "failure",
//             //     "message" => "Échec de l'ajout de l'image dans l'annonce.",
